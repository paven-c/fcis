...
public class UserController {
    ...
    public CommonResult<PageResult<UserRespVO>> getUserPage(@Valid UserPageReqVO pageReqVO) {
        ...
        return success(new PageResult<>(UserConvert.INSTANCE.convertList(pageResult.getList(), deptMap), pageResult.getTotalCount(), pageResult.getPageNum(),
    ...
    public void exportUserList(@Validated UserPageReqVO exportReqVO, HttpServletResponse response) throws IOException {
        ...
        // 输出 Excel
        Map<Long, Dept> deptMap = deptService.getDeptMap(convertList(list, User::getDeptId));
        com.paven.component.core.util.ExcelUtils.write(response, "用户数据.xls", "数据", UserRespVO.class, UserConvert.INSTANCE.convertList(list, deptMap));
    }
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        // 输出
        com.paven.component.core.util.ExcelUtils.write(response, "用户导入模板.xls", "用户列表", UserImportExcelVO.class, list);
    }
    ...
    public CommonResult<UserImportRespVO> importExcel(@RequestParam("file") MultipartFile file,
        ...
        List<UserImportExcelVO> list = com.paven.component.core.util.ExcelUtils.read(file, UserImportExcelVO.class);
