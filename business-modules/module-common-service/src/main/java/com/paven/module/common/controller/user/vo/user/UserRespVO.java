...
public class UserRespVO{
    ...
    @ExcelProperty(value = "用户性别", converter = com.paven.component.core.convert.DictConvert.class)
    @com.paven.component.core.annotations.DictFormat(DictTypeConstants.USER_SEX)
    ...
    @ExcelProperty(value = "帐号状态", converter = com.paven.component.core.convert.DictConvert.class)
    @com.paven.component.core.annotations.DictFormat(DictTypeConstants.COMMON_STATUS)
