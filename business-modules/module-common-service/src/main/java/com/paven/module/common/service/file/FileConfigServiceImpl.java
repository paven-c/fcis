package com.paven.module.common.service.file;


import static com.paven.common.exception.util.ServiceExceptionUtil.exception;
import static com.paven.common.util.cache.CacheUtils.buildAsyncReloadingCache;
import static com.paven.module.common.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.paven.module.common.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
import com.paven.module.common.component.file.core.client.FileClient;
import com.paven.module.common.component.file.core.client.FileClientConfig;
import com.paven.module.common.component.file.core.client.FileClientFactory;
...
import com.paven.module.common.convert.file.FileConfigConvert;
import com.paven.module.common.repository.mapper.file.FileConfigMapper;
...
public class FileConfigServiceImpl implements FileConfigService {
     ...
     */
    @Getter
    private final LoadingCache<Long, FileClient> clientCache = buildAsyncReloadingCache(
    ...
    public Long createFileConfig(FileConfigSaveReqVO createReqVO) {
        FileConfig fileConfig = FileConfigConvert.INSTANCE.convert(createReqVO)
                .setConfig(parseClientConfig(createReqVO.getStorage(), createReqVO.getConfig())).setMaster(false);
    ...
    public void updateFileConfig(FileConfigSaveReqVO updateReqVO) {
        ...
        // 更新
        FileConfig updateObj = FileConfigConvert.INSTANCE.convert(updateReqVO)
    ...
    @Override
    public PageResult<FileConfig> getFileConfigPage(FileConfigPageReqVO pageReqVO) {
