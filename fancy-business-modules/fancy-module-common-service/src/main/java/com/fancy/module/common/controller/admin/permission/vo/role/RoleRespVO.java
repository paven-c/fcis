package com.fancy.module.common.controller.admin.permission.vo.role;
 ...
 * @author paven
 */
@Schema(description = "角色信息ResponseVO")
@Data
...
public class RoleRespVO {
    ...
    @ExcelProperty(value = "角色状态", converter = com.fancy.component.core.convert.DictConvert.class)
