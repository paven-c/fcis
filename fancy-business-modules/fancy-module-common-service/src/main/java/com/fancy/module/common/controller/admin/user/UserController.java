package com.fancy.module.common.controller.admin.user;
...
import com.fancy.module.common.controller.admin.user.vo.user.UserUpdatePasswordReqVO;
import com.fancy.module.common.controller.admin.user.vo.user.UserUpdateStatusReqVO;
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("").deptId(1L).email("").mobile("")
                        .nickname("").status(CommonStatusEnum.ENABLE.getStatus()).sex(GenderEnum.MALE.getCode()).build(),
                UserImportExcelVO.builder().username("").deptId(2L).email("").mobile("")
                        .nickname("").status(CommonStatusEnum.DISABLE.getStatus()).sex(GenderEnum.FEMALE.getCode()).build()
        );
        // 输出
