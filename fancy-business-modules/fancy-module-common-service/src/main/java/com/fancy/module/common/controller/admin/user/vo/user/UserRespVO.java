 ...
 * @author paven
 */
@Schema(description = "用户信息ResponseVO")
@Data
...
public class UserRespVO{
    ...
    @ExcelProperty(value = "用户性别", converter = com.fancy.component.core.convert.DictConvert.class)
    @com.fancy.component.core.annotations.DictFormat(DictTypeConstants.USER_SEX)
    private Integer sex;
    ...
    @ExcelProperty(value = "帐号状态", converter = com.fancy.component.core.convert.DictConvert.class)
    @com.fancy.component.core.annotations.DictFormat(DictTypeConstants.COMMON_STATUS)
