package com.paven.component.excel.core.handler;
...
import com.paven.component.excel.core.annotations.ExcelColumnSelect;
import com.paven.component.excel.core.function.ExcelColumnSelectFunction;
...
public class SelectSheetWriteHandler implements SheetWriteHandler {
    ...
    public SelectSheetWriteHandler(Class<?> head) {
        // 加载下拉数据获取接口
        Map<String, ExcelColumnSelectFunction> beansMap = SpringUtil.getBeanFactory().getBeansOfType(
                ExcelColumnSelectFunction.class);
    ...
    private void getSelectDataList(int colIndex, Field field) {
        ...
        Map<String, ExcelColumnSelectFunction> functionMap = SpringUtil.getApplicationContext().getBeansOfType(
                ExcelColumnSelectFunction.class);
        ExcelColumnSelectFunction function = CollUtil.findOne(
