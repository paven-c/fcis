package com.paven.component.core.handler;
...
import com.paven.component.dict.core.DictFrameworkUtils;
...
public class SelectSheetWriteHandler implements SheetWriteHandler {
    ...
    public SelectSheetWriteHandler(Class<?> head) {
        // 加载下拉数据获取接口
        Map<String, com.paven.component.core.function.ExcelColumnSelectFunction> beansMap = SpringUtil.getBeanFactory().getBeansOfType(
                com.paven.component.core.function.ExcelColumnSelectFunction.class);
        ...
        for (Field field : head.getDeclaredFields()) {
            if (field.isAnnotationPresent(com.paven.component.core.annotations.ExcelColumnSelect.class)) {
    ...
    private void getSelectDataList(int colIndex, Field field) {
        com.paven.component.core.annotations.ExcelColumnSelect columnSelect = field.getAnnotation(com.paven.component.core.annotations.ExcelColumnSelect.class);
        ...
        Map<String, com.paven.component.core.function.ExcelColumnSelectFunction> functionMap = SpringUtil.getApplicationContext().getBeansOfType(
                com.paven.component.core.function.ExcelColumnSelectFunction.class);
        com.paven.component.core.function.ExcelColumnSelectFunction function = CollUtil.findOne(
                functionMap.values(), item -> item.getName().equals(functionName));
