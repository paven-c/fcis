package com.fancy.component.core.handler;
...
import com.fancy.common.core.KeyValue;
...
public class SelectSheetWriteHandler implements SheetWriteHandler {
    ...
    public SelectSheetWriteHandler(Class<?> head) {
        // 加载下拉数据获取接口
        Map<String, com.fancy.component.core.function.ExcelColumnSelectFunction> beansMap = SpringUtil.getBeanFactory().getBeansOfType(
                com.fancy.component.core.function.ExcelColumnSelectFunction.class);
        ...
        for (Field field : head.getDeclaredFields()) {
            if (field.isAnnotationPresent(com.fancy.component.core.annotations.ExcelColumnSelect.class)) {
    ...
    private void getSelectDataList(int colIndex, Field field) {
        com.fancy.component.core.annotations.ExcelColumnSelect columnSelect = field.getAnnotation(com.fancy.component.core.annotations.ExcelColumnSelect.class);
        ...
        Map<String, com.fancy.component.core.function.ExcelColumnSelectFunction> functionMap = SpringUtil.getApplicationContext().getBeansOfType(
                com.fancy.component.core.function.ExcelColumnSelectFunction.class);
        com.fancy.component.core.function.ExcelColumnSelectFunction function = CollUtil.findOne(
